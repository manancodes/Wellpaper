...
const FiltersModal = ({
  ...
  return (
    <BottomSheetModal
      ...
      backgroundStyle={{
        backgroundColor: theme.colors.dark(0.9),
      }}
    >
      <BottomSheetView style={styles.contentContainer}>
        <View style={styles.content}>
          ...
          {Object.keys(sections).map((sectionName, index) => {
            ...
            let title =
              sectionName == "image_type" ? "Type" : capitalize(sectionName);
            return (
              <Animated.View
          ...
          >
            <Pressable style={styles.resetButton} onPress={onReset}>
              <Text
                style={[styles.buttonText, { color: theme.colors.neutral(1) }]}
              >
                Reset
              </Text>
            </Pressable>
...
const CustomBackrop = ({ animatedIndex, style }: any) => {
